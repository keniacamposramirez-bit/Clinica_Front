...
// MAPA DE ESTADOS PARA LOS PILLS
const statusMap = {
  'Activo': 'green',
  'En observación': 'amber',
  'Alta': 'blue'
}
    ...
    <div className="module">
      ...
      <div className="stats-row">
        ...
        <StatCard
          icon=""
          label="Activos"
          value={data.filter(p => p.estado).length}
          sub="en tratamiento"
        />
      ...
      >
        ...
        <div className="form-grid">
          ...
          <FormField label="DUI">
            <input
              value={form.dui}
              onChange={e => f('dui', e.target.value)}
          ...
          <FormField label="Fecha nacimiento">
            <input
              ...
              onChange={e => f('fecha_nacimiento', e.target.value)}
            />
          </FormField>
          ...
          <FormField label="Género">
            <select
              ...
              onChange={e =>
                f('id_genero', parseInt(e.target.value))
              }
            >
          ...
          <div className="form-field">
            ...
            <textarea
              ...
              placeholder="Penicilina, polvo, mariscos. Si no presenta alergias escribir: Ninguna"
            />
          ...
          <div className="form-field">
            ...
            <label className="form-label">
              ¿Consume medicamentos actualmente?
            </label>
            ...
            <textarea
              ...
              className="w-full border p-2 rounded"
              placeholder="Paracetamol, Ibuprofeno. Si no consume escribir: Ninguno"
            />
